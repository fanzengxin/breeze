...
public class Des {
     ...
     * @return
     */
    public static String str_dec(String str) {
        String firstKey = "share";
        String secondKey = "share.com";
        String thirdKey = "www.share.com";
        Des desObj = new Des();
     ...
     * @return
     */
    public static String str_enc(String str) {
        String firstKey = "share";
        String secondKey = "share.com";
        String thirdKey = "www.share.com";
        Des desObj = new Des();
        String dec = desObj.strEnc(str, firstKey, secondKey, thirdKey);
        return dec;
    }
