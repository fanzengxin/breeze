...
public class LoginSession {
    ...
    public static LoginInfo getLoginInfo(String auth_code, Serial serial) {
        String info = UtilRedis.getRedis(Redis.REDIS_LOGIN_DB).get(LOGIN_INFO_REDIS_PREFIX + auth_code, serial);
    ...
    public static String setLoginInfo(LoginInfo loginInfo, Serial serial) {
        ...
        UtilRedis.getRedis(Redis.REDIS_LOGIN_DB).setex(LOGIN_INFO_REDIS_PREFIX + sessionId, CommonConfig.getLoginSessionValidityTime(),
    ...
    public static boolean checkUserLocked(String userId, Serial serial) {
        String userStatus = UtilRedis.getRedis(Redis.REDIS_LOGIN_DB).get(LOCK_INFO_REDIS_PREFIX + userId, serial);
